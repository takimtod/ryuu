...
data
  ...
  */
  conn.sendMedia = async (jid, path, quoted, options = {}) => {
      ...
      return await conn.sendMessage(jid, { [`${pase}`]: data, mimetype: mime }, { quoted, ...options })
  }
...
*/
  ...
  m.reply = async (text, options = {}) => {
        if (typeof text === "string") {
           return await conn.sendMessage(m.chat, { text, ...options }, { quoted: m, ...options })
        } else if (typeof text === "object" && typeof text !== "string") {
           return conn.sendMessage(m.chat, { ...text, ...options }, { quoted: m, ...options })
        }
     }
